...
import Search from "./components/Navbar.jsx";
...
function App() {
  ...
  return (
    <div className={`App ${weatherCondition}`}>
      <Search onSearchChange={handleOnSearchChange} searchHistory={searchHistory} setSearchHistory={setSearchHistory}  onCurrentLocationClick={getCurrentLocationWeather}/>
      ...
      {searchHistory.length > 0 && (
        <div className="history-section border border-gray-800 rounded-[2rem] w-[15rem] px-8 py-4 backdrop-blur-xl shadow-2xl relative left-14 top-[-14rem] lg:left-[56rem] lg:top-[-26rem] xl:absolute xl:left-[30rem] xl:top-[50rem] xl:w-[22rem]">
          <h2 className="text-lg text-slate-50 md:text-xl">Search History</h2>
          <ul className="text-slate-50 pt-2 cursor-pointer md:text-xl">
