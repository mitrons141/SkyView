...
const Air = ({ datas }) => {
  ...
  return (
    <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[31rem] p-6 absolute left-[29rem] top-[11.6rem]">
  ...
  return (
    <div className="px-4 pt-8 absolute top-[4.6rem] left-[25rem]">
      <div className="border border-gray-800 rounded-[2rem] w-[91rem] h-[27rem] px-8 pb-8 pt-2 bg-transparent shadow-2xl">
        ...
        <br />
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[15rem] p-4 absolute top-[18.4rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[15rem] p-4 absolute top-[18.4rem] left-[20rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[31rem] p-6 pb-8 absolute top-[7em] left-[37rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[15rem] p-4 absolute top-[18.4rem] left-[37rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[15rem] p-4 absolute top-[18.4rem] left-[53rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[21rem] p-[1.6rem] absolute top-[7rem] left-[70rem]">
        ...
        <div className="border border-gray-700 rounded-[1rem] bg-transparent w-[21rem] p-4 absolute top-[18.4rem] left-[70rem]">
